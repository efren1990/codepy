...
class UserModel(db.Model):
	...
	#----------------------------------------------------------
	# @METHOD: json format - toma las propiedades y crea un diccionario                         
	# @PARAMS: id, nombreUsuario, contraseña                       
	#----------------------------------------------------------
	def json(self):
		return {
	...
	#----------------------------------------------------------
	# @CLASSMETHOD: Busca por nombre de usuario                        
	...
	#----------------------------------------------------------
	# @CLASSMETHOD: Busca por nombre de id usuario                        
	# @PARAMS: NombreUsuario           
	#----------------------------------------------------------
	@classmethod
	...
	#----------------------------------------------------------
	# @METHOD: Guarda un objeto en la base de datos                       
	...
	def save_to_db(self):
		...
		db.session.commit()
	#----------------------------------------------------------
	# @METHOD: Elimina un objeto en la base de datos                       
	# @PARAMS: self- en objeto en si            
	#----------------------------------------------------------
	def delete_from_db(self):
		# Eliminar objeto flask alchemy
